...
<div class="adslist">
  <script type="text/javascript">
    <?php if (!$nid) : ?>
    _ef_ads_load('.simpleads-<?php print $tid; ?><?php if ($prefix) : ?><?php print $prefix; ?><?php endif; ?>', '<?php print $tid; ?>', <?php print check_plain($ads_limit); ?>);
    <?php else: ?>
    _ef_ads_load('.simpleads-<?php print $tid; ?><?php if ($prefix) : ?><?php print $prefix; ?><?php endif; ?>', '<?php print $tid; ?>', <?php print check_plain($ads_limit); ?>, <?php print $nid; ?>);
    <?php endif;?>
  </script>
